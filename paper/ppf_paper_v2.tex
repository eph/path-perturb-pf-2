...
\begin{figure}[t]
\centering
\includegraphics[width=0.78\linewidth]{../pppf-mixture-rbpf/output/burnside/irf_1.png}
...
We simulate data from the discretized global benchmark and compute its (exact) likelihood by a forward algorithm on the discrete Markov chain.
...
In this configuration, OccBin tracks the global benchmark more closely than PPPF in IRF RMSE, while PPPF remains faster and exhibits higher ESS in likelihood evaluation.

\begin{figure}[t]
\centering
\includegraphics[width=0.92\linewidth]{../pppf-mixture-rbpf/output/nk/irf.png}
...
\centering
\includegraphics[width=\linewidth]{../pppf-mixture-rbpf/output/nk/loglik_hist.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{../pppf-mixture-rbpf/output/nk/ess.png}
\end{minipage}
\caption{NK--ELB benchmark diagnostics (reference implementation): histogram of repeated log-likelihood estimates and ESS profile over time.}
\label{fig:nk_diag}
\end{figure}
