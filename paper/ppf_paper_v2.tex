...
The tradeoff is higher runtime per likelihood evaluation and (in this configuration) a larger approximation bias relative to the global discrete benchmark.
